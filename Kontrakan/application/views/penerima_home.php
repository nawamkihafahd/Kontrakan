...
<body>
	...
	<a class="btn btn-primary btn-block" href="<?php echo base_url(). 'Penerima/formaddPenerima'; ?>">Tambah Penerima</a>
	<br>
	<a class="btn btn-primary btn-block" href="<?php echo base_url(). 'Penerima/Penerimaall'; ?>">Lihat Semua Penerima</a>
	<br>
</div>
</div>
    </div>
