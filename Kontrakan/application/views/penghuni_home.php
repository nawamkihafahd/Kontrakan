...
<body>
	...
	<a class="btn btn-primary btn-block" href="<?php echo base_url(). 'Penghuni/formaddpenghuni'; ?>">Tambah Penghuni</a>
	<br>
	<a class="btn btn-primary btn-block" href="<?php echo base_url(). 'Penghuni/penghuniall'; ?>">Lihat Semua Penghuni</a>
	<br>
</div>
</div>
    </div>
