...
<body>
    ...
    <div class="card card-register mx-auto mt-5">
      <div class="card-body">
	<a class="btn btn-primary btn-block" href="<?php echo base_url(). 'Barang/formaddBarang'; ?>">Tambah Barang</a>
	<br>
	<a class="btn btn-primary btn-block" href="<?php echo base_url(). 'Barang/Barangall'; ?>">Lihat Semua Barang</a>
	<br>
	</div>
    </div>
  </div>
