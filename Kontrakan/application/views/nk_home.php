...
<body>
    ...
    <div class="card card-register mx-auto mt-5">
      <div class="card-body">
	<a class="btn btn-primary btn-block" href="<?php echo base_url(). 'Notakomunal/formaddnk'; ?>">Tambah Nota Komunal</a>
	<br>
	<a class="btn btn-primary btn-block" href="<?php echo base_url(). 'Notakomunal/nkall'; ?>">Lihat Semua Nota Komunal</a>
	<br>
</div>
</div>
    </div>
