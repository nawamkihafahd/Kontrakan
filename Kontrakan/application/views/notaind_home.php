...
<body>
    ...
    <div class="card card-register mx-auto mt-5">
      <div class="card-body">
	<a class="btn btn-primary btn-block" href="<?php echo base_url(). 'NotaInd/NotaIndAll'; ?>">Lihat Semua Nota</a>
	<br>
	<a class="btn btn-primary btn-block" href="<?php echo base_url(). 'NotaInd/formaddNotaInd'; ?>">Tambah Nota</a>
	</div>
    </div>
  </div>
</div>
