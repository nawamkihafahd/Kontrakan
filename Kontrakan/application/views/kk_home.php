...
<body>
	...
	<a class="btn btn-primary btn-block" href="<?php echo base_url(). 'Kategorikomunal/formaddkategori'; ?>">Tambah Kategori Komunal</a>
	<br>
	<a class="btn btn-primary btn-block" href="<?php echo base_url(). 'Kategorikomunal/kategoriall'; ?>">Lihat Semua Kategori Komunal</a>
	<br>
	</div>
    </div>
  </div>
